...
public class GeometriesTests {
	...
	public void testFindIntsersections() {
		...
		assertEquals("The test failed, the function found an intersection point",0,IntsersectionsList1.size(),0.1);
		...
		Geometries geometries2= new Geometries(triangle,sphere,plane);
		List IntsersectionsList2= geometries2.findIntsersections(ray2);		
		assertEquals("The test failed, the function found an intersection point",0,IntsersectionsList2.size(),0.1);
		// =============== Boundary Values Tests ==================
	...
	if (spherePoints.size()!=0) {
      ...
      //All shapes are cut
	   ...
	   Geometries geometries4= new Geometries(triangle,sphere,plane);
		...
		assertEquals("The test failed, the function did not found the expected amount of intersection point ",4,IntsersectionsList2.size(),0.1);
